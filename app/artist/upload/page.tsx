...
export default function UploadSongPage() {
  ...
  // 🧠 DEBUG: Aktuellen Supabase-User in Konsole ausgeben
  useEffect(() => {
  ...
  const handleFileUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 🎨 Artist-Konto holen oder erstellen
      ...
      if (!artistAccount) {
        console.log("⚙️ Kein Artist-Account — wird erstellt ...")
      ...
      // 💾 In Tabelle speichern (mit user_id! wichtig für RLS)
